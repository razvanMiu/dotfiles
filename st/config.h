...
/* Background opacity; requires an X compositor such as picom. */
float alpha = 1.0;

/* Catppuccin Macchiato terminal colors (16 first used in escape sequence). */
